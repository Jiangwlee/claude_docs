...
Claude Code 提供了三种核心的定制化功能，每种功能解决不同层面的问题：

- **Custom Slash Commands**：可复用的提示词模板，提高工作效率
- **Sub-agents**：专业化的独立任务处理器，实现任务专业化
- **Output Styles**：系统级的交互方式定制，改变整体行为模式

理解这三者的区别和适用场景，能帮助你选择最适合的解决方案。
